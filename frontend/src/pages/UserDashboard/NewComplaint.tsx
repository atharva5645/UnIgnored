              ...
              {STEPS.map((s, i) => (
                <div key={s.id} className="flex flex-col items-center gap-2 group cursor-pointer" onClick={() => step > i && setStep(i)}>
                  ...
                  <span className={clsx(
                    ...
                    step === i ? 'text-white' : step > i ? 'text-primary-400' : 'text-slate-700'
                  )}>
                    {s.title}
                  </span>
              ...
              <AnimatePresence mode="wait">
                {step === 0 && (
                  <motion.div key="step0" initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -10 }}>
                    <div className="mb-10">
                      <h2 className="text-2xl font-bold text-white mb-2">How are you reporting?</h2>
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-6">
                        {[
                          ...
                          >
                            ...
                            <div>
                              <h4 className={clsx('text-sm font-bold', reportType === type.id ? 'text-white' : 'text-slate-400')}>{type.label}</h4>
                    ...
                    <div className="space-y-6">
                      <div className="h-72 rounded-none bg-dark-900 border border-white/5 relative overflow-hidden">
                        ...
                        <Button 
                          ...
                          className="absolute bottom-6 right-6 bg-dark-950/95 shadow-glow-blue max-w-[80%] overflow-hidden z-[1000]"
                        >
                    ...
                    <div className="space-y-6">
                      <div className="p-6 rounded-none bg-white/5 border border-white/5 space-y-6">
                        ...
                        <div>
                          ...
                          <h3 className="text-lg font-bold text-white mb-1">{data.title || "No Title Provided"}</h3>
                        ...
                        <div>
                          ...
                          <p className="text-sm text-white font-medium">{data.location.address || "No address specified."}</p>
                        </div>
                        ...
                        <div className="space-y-4">
                          ...
                          <div className="flex justify-between items-center">
                            ...
                            <span className="text-white font-bold capitalize">{reportType} Report</span>
                          </div>
                          <div className="flex justify-between items-center">
                            <span className="text-slate-500 text-[10px] font-bold uppercase tracking-widest">Ward</span>
                            <span className="text-white font-bold">{data.location.ward || "Unknown Ward"}</span>
                          </div>
                          <div className="flex justify-between items-center">
                            <span className="text-slate-500 text-[10px] font-bold uppercase tracking-widest">Evidence</span>
                            <span className="text-white font-bold">{files.length} Photo{files.length !== 1 ? 's' : ''} Attached</span>
                          </div>
                        </div>
