          ...
          <div className="lg:col-span-4 space-y-6">
            <Card className="p-8 text-center relative overflow-hidden">
              ...
              <div className="relative z-10 pt-4">
                <div className="relative inline-block group">
                  <Avatar name={user.name} src={user.avatar} size="lg" className="w-24 h-24 mx-auto border-4 border-dark-950 shadow-2xl" />
                ...
                <h2 className="text-2xl font-black text-white mt-6 font-display">{user.name}</h2>
              ...
              <div className="mt-10 pt-10 border-t border-white/5 space-y-4">
                <div className="flex items-center justify-between text-sm">
                  ...
                  <span className="text-white font-mono text-xs">CE-USR-8821</span>
                </div>
                <div className="flex items-center justify-between text-sm">
            ...
            <Card className="p-6">
              ...
              <div className="grid grid-cols-4 gap-4">
                {user.badges.map(b => (
                  <div key={b.id} title={b.name} className="w-12 h-12 rounded-xl bg-white/5 flex items-center justify-center text-2xl shadow-inner cursor-help hover:scale-110 transition-transform">
                    {b.icon}
                  </div>
                ))}
            ...
            <AnimatePresence mode="wait">
                  ...
                  <Card className="p-8">
                    ...
                    <div className="space-y-6">
                      <div className="flex items-center gap-4 p-4 rounded-2xl bg-white/5 border border-white/5">
                        <div className="w-10 h-10 rounded-xl bg-dark-950 flex items-center justify-center text-primary-500"><Phone size={18} /></div>
                        <div>
                      ...
                      <div className="flex items-center gap-4 p-4 rounded-2xl bg-white/5 border border-white/5">
                        <div className="w-10 h-10 rounded-xl bg-dark-950 flex items-center justify-center text-primary-500"><Mail size={18} /></div>
                        <div>
                    ...
                    <div className="space-y-4">
                      {user.addresses.map((addr, i) => (
                        <div key={i} className="flex items-center gap-4 p-4 rounded-2xl bg-white/5 border border-white/5">
                          <div className="w-10 h-10 rounded-xl bg-dark-950 flex items-center justify-center text-primary-500"><MapPin size={18} /></div>
                          <div>
                            <p className="text-xs font-bold text-white">{addr.label} {addr.isDefault && <Badge variant="info" className="ml-2">Default</Badge>}</p>
              ...
              {activeTab === 'settings' && (
                <motion.div key="settings" initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} className="space-y-6">
                  ...
                  <Card className="p-8">
                    <h3 className="text-lg font-bold text-white mb-6">Communication Preferences</h3>
                    <div className="space-y-4">
